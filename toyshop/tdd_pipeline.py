...
# Design.md parsers — canonical home is snapshot.py (re-exported for compat)
from toyshop.snapshot import _parse_design_interfaces, _parse_design_modules  # noqa: F401
